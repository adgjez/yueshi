 ...
 * 辅助按键配置
 */
class KeyboardAssistsConfig @JvmOverloads constructor(private val callBack: CallBack = object : CallBack { override fun requestLayout() {} }) : BaseDialogFragment(R.layout.dialog_recycler_view),
